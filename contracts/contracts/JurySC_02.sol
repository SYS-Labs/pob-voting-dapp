 ...
 */
contract JurySC_02 is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function registerProject(address projectAddress_) external onlyOwner {
        ...
        // Note: No need to check pob.hasMintedBadge() - Community can only mint during
        // active voting, which happens AFTER projects are locked at activation
     ...
     * @return Array of project addresses (in registration order)
     */
     ...
     * @dev Upgrades are blocked after activation and after contract is locked for history
     *      This prevents post-vote manipulation between voting end and lockContractForHistory()
     */
