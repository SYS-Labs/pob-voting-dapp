...
contract PoB_02 is ERC721, Ownable, ReentrancyGuard {
    ...
    function mint() external payable returns (uint256) {
        ...
        IJurySC_02 jury = IJurySC_02(juryAddress);
    ...
    function claim(uint256 tokenId) external nonReentrant {
        ...
        IJurySC_02 jury = IJurySC_02(owner());
    ...
    /**
     * @notice Check if an address has already minted a badge
     ...
     * @dev Minting (from=0) and burning (to=0) are always allowed
     *      Transfers between accounts are blocked while voting is active
     */
